        ...
        while choose_option != "0":
            ...
            if choose_option == "1":
                ...
                if Input3 in Regimen_for_All_Member:
                    Input4 = int(input("Enter Total Number of day you want to change in the  Regimen -\n--"))
